...
export default () => {
  ...
  const obj = useSelector(state => state.companies.obj);
  ...
  const handleSave = () => {
    dispatch(CompanySlice.actions.update(params.id, data))
      .then(() => setCreated(true))
  }

  return (
    <React.Fragment>
      {created && <CAlert color="success"> Company {params.id} updated! </CAlert>}
      <Form
